      ...
      <main id="top">
        ...
        <section className="experience section-frame" id="experience" aria-labelledby="experience-title">
          ...
          <div className="experience-list">
            <article className="experience-item"><p className="experience-period">Aug 2026 — Present</p><div><p className="experience-role">AI/ML Expert Contributor</p><h3>Snorkel AI (Freelance)</h3></div><ul><li>Selected as an Expert Contributor for Project Otter, evaluating and improving expert-level AI-generated outputs.</li><li>Applying machine learning, Python, and technical reasoning to assess model performance and identify errors.</li><li>Producing high-quality solutions to refine and enhance production AI models.</li></ul></article>
